...
public class TSS {
    ...
    /** 
     * @param str
     * @return la posición (indice) donde se encuentra str.  Si str no existe, devuelve -1
     */
    ...
    public String getStr(int index){ //Devuelve la StingCtte de la posición (índice) index de L.
...
//----------
    ...
    private int LongitudFila(){ //Calcula la longitud del string más largo.
